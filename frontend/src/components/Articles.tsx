...
const Articles = () => {
  return (
    <section className="mb-20 bg-[oklch(21.8%_0.008_223.9)] px-6 py-20 md:mb-28 lg:px-16">
      <div className="mx-auto flex max-w-7xl flex-col gap-6 md:flex-row md:items-start md:justify-between md:gap-8">
      ...
      <div className="mx-auto mt-12 grid max-w-7xl grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {articles.map((article) => (
          <article key={article.title} className="flex flex-col bg-black">
            <img
              src={article.image}
              alt={article.title}
